...
function create_db_structure(callback)
{
  ...
  console.log("CREATE TABLE IF NOT EXISTS admin (admin_dn VARCHAR(255) NOT NULL, admin_cn VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, uid VARCHAR(255) NOT NULL, PRIMARY KEY ( admin_dn ), INDEX admin_idx (admin_dn));");

  console.log("CREATE TABLE IF NOT EXISTS testing_id (id VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, INDEX testing_id_idx(id));");

  //console.log("CREATE TABLE IF NOT EXISTS realm (id INT NOT NULL AUTO_INCREMENT, realm_dn VARCHAR(255) NOT NULL, realm_cn VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, member_type VARCHAR(255) NOT NULL, realm_manager VARCHAR(255) NOT NULL, FOREIGN KEY (realm_manager) REFERENCES admin(admin_dn), testing_id VARCHAR(255) NOT NULL, testing_pass VARCHAR(255) NOT NULL, PRIMARY KEY ( id ), UNIQUE ( id ), INDEX realm_idx (realm_dn));");

  console.log("CREATE TABLE IF NOT EXISTS realm (id INT NOT NULL AUTO_INCREMENT, realm_dn VARCHAR(255) NOT NULL, realm_cn VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, member_type VARCHAR(255) NOT NULL, realm_manager VARCHAR(255) NOT NULL, FOREIGN KEY (realm_manager) REFERENCES admin(admin_dn), testing_id VARCHAR(255), FOREIGN KEY (testing_id) REFERENCES testing_id(id), PRIMARY KEY ( id ), UNIQUE ( id ), INDEX realm_idx (realm_dn));");

  console.log("CREATE TABLE IF NOT EXISTS radius_server (id INT NOT NULL AUTO_INCREMENT, radius_dn VARCHAR(255) NOT NULL, radius_cn VARCHAR(255) NOT NULL, inf_radius_secret VARCHAR(255) NOT NULL, transport VARCHAR(255) NOT NULL, mon_radius_secret VARCHAR(255) NOT NULL, mon_realm VARCHAR(255), FOREIGN KEY (mon_realm) REFERENCES realm(realm_dn), inf_realm VARCHAR(255), FOREIGN KEY (inf_realm) REFERENCES realm(realm_dn), radius_manager VARCHAR(255) NOT NULL, FOREIGN KEY (radius_manager) REFERENCES admin(admin_dn), PRIMARY KEY ( id ), UNIQUE ( id ), INDEX radius_server_idx (radius_dn));");
